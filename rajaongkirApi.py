...
class rajaongkirApi:
    """
    rajaongkirApi::__init__

    Get detail of __init__

    @param   String     key             Rajaongkir API Key
    @param   String     accountType     Courier Code
    
    #contoh
    rajaongkirApi(key="3kj12gk31j2gkj1", accountType="starter")
    """
